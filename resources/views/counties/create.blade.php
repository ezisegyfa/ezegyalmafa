    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-5 mb-5">Create New County</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" accept-charset="UTF-8" id="create_county_form" name="create_county_form" class="form-horizontal">
            {{ csrf_field() }}
...
<script type="text/javascript">
    $(document).ready(function(){
        var form = $('#create_county_form')
        form.on('submit', function(e){
            e.preventDefault()

            var postData = getFormData(form)
            var redirectUrl = '{!! route('counties.county.store') !!}'
