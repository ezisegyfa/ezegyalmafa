    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-3 mb-3">@lang('view.Create new') @lang('view.County')</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('counties.county.store') }}" accept-charset="UTF-8" id="create_county_form" name="create_county_form" class="form-horizontal">
            {{ csrf_field() }}
