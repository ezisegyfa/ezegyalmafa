    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-3 mb-3">@lang('view.Create new') @lang('view.Driver Car')</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('driver_cars.driver_car.store') }}" accept-charset="UTF-8" id="create_driver_car_form" name="create_driver_car_form" class="form-horizontal">
            {{ csrf_field() }}
