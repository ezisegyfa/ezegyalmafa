...
<div class="panel panel-default">
    ...
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right mb-3">
            ...
            <form method="POST" action="{!! route('process_types.process_type.destroy', $processType->id) !!}" accept-charset="UTF-8">
            ...
            {{ csrf_field() }}
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <a href="{{ route('process_types.process_type.edit', $processType->id ) }}" class="btn btn-primary" title="Edit Process Type">
                        <span class="glyphicon glyphicon-pencil" aria-hidden="true">@lang('view.Edit')</span>
                    </a>

                    <button type="submit" class="btn btn-danger" title="Delete Process Type" onclick="return confirm(&quot;Delete Process Type??&quot;)">
    ...
    <div class="panel-body">
        <dl class="dl-horizontal">
            ...
            <dd>{{ $processType->getRenderValue()}}</dd>
