...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('settlements.settlement.update', $settlement->id) }}" id="edit_settlement_form" name="edit_settlement_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
