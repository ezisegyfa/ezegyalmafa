    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-3 mb-3">@lang('view.Create new') @lang('view.Buyer')</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('buyers.buyer.store') }}" accept-charset="UTF-8" id="create_buyer_form" name="create_buyer_form" class="form-horizontal">
            {{ csrf_field() }}
            @include ('buyers.form', [
                                        'buyer' => null,
                                      ])
