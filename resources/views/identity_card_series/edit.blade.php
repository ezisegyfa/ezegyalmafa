...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('identity_card_series.identity_card_series.update', $identityCardSeries->id) }}" id="edit_identity_card_series_form" name="edit_identity_card_series_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
