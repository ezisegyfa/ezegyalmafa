...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('stock_transports.stock_transport.update', $stockTransport->id) }}" id="edit_stock_transport_form" name="edit_stock_transport_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
