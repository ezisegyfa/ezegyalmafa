    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-3 mb-3">@lang('view.Create new') @lang('view.Stock Transport')</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('stock_transports.stock_transport.store') }}" accept-charset="UTF-8" id="create_stock_transport_form" name="create_stock_transport_form" class="form-horizontal">
            {{ csrf_field() }}
