    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-3 mb-3">@lang('view.Create new') @lang('view.Material Type')</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('material_types.material_type.store') }}" accept-charset="UTF-8" id="create_material_type_form" name="create_material_type_form" class="form-horizontal">
            {{ csrf_field() }}
