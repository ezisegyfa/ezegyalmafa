...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('buyer_observations.buyer_observation.update', $buyerObservation->id) }}" id="edit_buyer_observation_form" name="edit_buyer_observation_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
            <input name="_method" type="hidden" value="PUT">
            @include ('buyer_observations.form', [
                                        'buyerObservation' => $buyerObservation,
                                      ])
