...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('buyer_notifications.buyer_notification.update', $buyerNotification->id) }}" id="edit_buyer_notification_form" name="edit_buyer_notification_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
