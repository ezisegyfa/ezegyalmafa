    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <span class="pull-left">
                <h4 class="mt-5 mb-5">Create New Buyer Notification</h4>
            </span>
        ...
        <div class="panel-body">
            ...
            <form method="POST" accept-charset="UTF-8" id="create_buyer_notification_form" name="create_buyer_notification_form" class="form-horizontal">
            {{ csrf_field() }}
...
<script type="text/javascript">
    $(document).ready(function(){
        var form = $('#create_buyer_notification_form')
        form.on('submit', function(e){
            e.preventDefault()

            var postData = getFormData(form)
            var redirectUrl = '{!! route('buyer_notifications.buyer_notification.store') !!}'
