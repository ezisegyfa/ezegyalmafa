...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('buyer_notifications.buyer_notification.store') }}" accept-charset="UTF-8" id="create_buyer_notification_form" name="create_buyer_notification_form" class="form-horizontal">
            {{ csrf_field() }}
